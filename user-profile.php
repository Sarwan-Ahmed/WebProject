<!DOCTYPE html>
	...
	<body>
		...
		<div class="row row-1" style="margin: 70px 0px;">
    ...
    <ul class="nav nav-tabs">
    	<li class="nav-item">
            <a  href="#collections" class="nav-link active" data-toggle="tab">Collections</a>
        </li>
        <li class="nav-item">
            <a  href="#likes" class="nav-link" data-toggle="tab">Likes</a>
        </li>
